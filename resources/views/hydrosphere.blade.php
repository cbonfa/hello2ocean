@php
    $actions = [
        ...
        [
            'route' => 'hydrosphere.affinity_thresholds.index',
            'title' => 'Affinity Thresholds',
            'description' => 'Set the affinity needed to reveal each fisher field.',
            'count' => $counts['affinity_thresholds'],
