        ...
        <div class="relative max-w-[340px] bg-white shadow-lg rounded-lg">
            ...
            <!-- Bottom right button -->
            {{-- <button onclick="javascript:sendMessage(2)" class="absolute bottom-5 right-5 inline-flex items-center text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 rounded-full text-center px-3 py-2 shadow-lg focus:outline-none focus-visible:ring-2">
