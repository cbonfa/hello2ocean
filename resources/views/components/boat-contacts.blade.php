        ...
        <div class="relative max-w-[340px] bg-white shadow-lg rounded-lg">
            ...
            <header class="pt-6 pb-4 px-5 border-b border-gray-200">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <div class="relative inline-flex flex-shrink-0">
                        <a class="text-gray-400 hover:text-gray-500 rounded-full focus:ring-0 outline-none focus:outline-none" href=" {{ route('boat.fisher.edit') }}">
                                ...
                                <div :id="['fisher_' + contact.id]"  
                                    ...
                                    <button @click.prevent="showChat=true; $nextTick(() => { $refs.input_message.focus(); });" class="w-full text-left py-2 focus:outline-none focus-visible:bg-indigo-50">
                                        <div class="flex items-center">
                                            ...
                                            <img class="rounded-full items-start flex-shrink-0 mr-3" :src="contact.nick_image" width="32" height="32" :alt="contact.name" />
                                            <div>
            ...
            <!-- Bottom right button -->
            {{-- <button wire:click="add_contact" class="absolute bottom-5 right-5 inline-flex items-center text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 rounded-full text-center px-3 py-2 shadow-lg focus:outline-none focus-visible:ring-2">
